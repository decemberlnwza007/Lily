...
export default function EstimateForm() {
    ...
    const options = [
        { value: 0, label: "ไม่เลย", color: "bg-green-100 text-green-800 hover:bg-green-200" },
        { value: 1, label: "เป็นบางวัน 1 - 7 วัน", color: "bg-yellow-100 text-yellow-800 hover:bg-yellow-200" },
        { value: 2, label: "เป็นบ่อย > 7 วัน", color: "bg-orange-100 text-orange-800 hover:bg-orange-200" },
        { value: 3, label: "มากกว่า 7 วัน", color: "bg-red-100 text-red-800 hover:bg-red-200" }
    ]
    ...
    const handleAnswer = (value) => {
        ...
        setTimeout(() => {
            if (currentQuestion < questions.length - 1) {
                ...
                alert(`การประเมินเสร็จสิ้น คะแนนรวม: ${Object.values(newAnswers).reduce((sum, val) => sum + val, 0)}`);
            }
        }, 500);
    };
