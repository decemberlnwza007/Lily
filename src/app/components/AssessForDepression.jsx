...
export default function AssessForDespression() {
    ...
    const options = [
        { value: 0, label: "ไม่มี", color: "bg-emerald-100 text-emerald-800 hover:bg-emerald-200 border-emerald-200", icon: "" },
        { value: 1, label: "มี", color: "bg-amber-100 text-amber-800 hover:bg-amber-200 border-amber-200", icon: "" },
    ];
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-mint-50 via-mint-500 to-indigo-100 p-6 relative overflow-hidden">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-gradient-to-r from-emerald-400/20 to-teal-400/20 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
                <div className="absolute top-1/2 left-1/4 w-64 h-64 bg-gradient-to-r from-pink-400/10 to-rose-400/10 rounded-full blur-3xl animate-pulse" style={{animationDelay: '4s'}}></div>
            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
                        ...
                        <div className="p-12 flex flex-col justify-center bg-gradient-to-br from-white/50 to-blue-50/30 relative">
                            ...
                            <div className="space-y-8 mt-8">
                                <div className="transform transition-all duration-500 ease-out" key={currentQuestion}>
            ...
            <style jsx>{`
                ...
                .from-mint-500 { background-color: #14b8a6; }
                .text-mint-600 { color: #0d9488; }
                .text-mint-700 { color: #0f766e; }
                .border-mint-100 { border-color: #ccfbf1; }
                ...
                .hover\\:text-mint-600:hover { color: #0d9488; }
                .hover\\:text-mint-700:hover { color: #0f766e; }
                .bg-mint-50\\/50 { background-color: rgb(240 253 250 / 0.5); }
                .ring-mint-300 { --tw-ring-color: #5eead4; }
                .bg-mint-300 { background-color: #5eead4; }
