...
`
  ...
  return (
    <div className="flex flex-col w-12/12  bg-gradient-to-br from-slate-50 via-green-50 to-purple-50 overflow-hidden">
...
function ChatArea({ messages, loading }) {
  return (
    <div className="flex-1 overflow-y-auto py-6 px-2 sm:px-4">
      <div className="max-w-5xl mx-auto space-y-4 flex flex-col">
        {messages.map((msg, i) => (
          <div
            key={i}
...
function InputBar({ input, setInput, onSend, onQuickSelect, loading }) {
  return (
    <>
      ...
      <div className="sticky bottom-0 bg- backdrop-blur-sm w-10/12 mx-auto rounded-t-3xl shadow-2xl border-t border-green-300 z-10">

        <div className="max-w-full md:max-w-12xl mx-auto px-4 py-6">
